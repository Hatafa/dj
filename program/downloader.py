...
@Client.on_message(command(["song", "نزيل" f"song@{bn}"]) & ~filters.edited)
def song(_, message):
    query = " ".join(message.command[1:])
    m = message.reply("🔎 جـــاري تحــميل الاغـــنــيــة...")
    ...
    try:
        ...
        m.edit("❌ لم يتم العثور علي الملف.\n\nplease give a valid song name.")
        print(str(e))
        return
    m.edit("📥 تـــحـــمــيــل الـــمــلــف...")
    try:
        ...
        m.edit("❌ خطأ ، انتظر حتى يصلح مالك الروبوت")
        print(e)
